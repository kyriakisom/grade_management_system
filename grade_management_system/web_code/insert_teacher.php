...
<html lang="el">
<head>
  <title>Εισαγωγή Βαθμολογίας</title>
  <meta charset="utf-8">
...
&nbsp;
  ...
  <center>
    ...
    <br>
    <form name="contactform" method="post" action="insert_teacher.php">
        ...
        <table width="50%" class=form>
          <hr class="new5"></hr>
            ...
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Όνομα φοιτητή:</text> </b></td>
                <td><input type="text" name="Student_Firstname" maxlength="80" size="30" value=<?php echo $Student_Firstname ?>></td>
            </tr>
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Επώνυμο φοιτητή:</text> </b></td>
            ...
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Ημερομηνία εξέτασης:</style> </b></td>
