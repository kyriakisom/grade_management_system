...
<body>
  ...
  <a href="index_admin_1.php" class="btn1 w3-bar-item w3-button w3-hide-small"><i style="font-size:18px" class="fa">&#xf100;</i>
  </a>
  ...
  &nbsp;
          <button class="btn1"><a href="index_admin_1.php" ><i style="font-size:18px" class="fa">&#xf100;</i>
        </a></button>
        &nbsp;
...
<center>
            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Lastname']; ?></td>
                ...
                <td valign="center" align="center">
                    <form name="updateform" method="post" action="update_admin.php">
    ...
    <form name="contactform" method="post" action="update_admin.php">
        ...
        <table width="50%" class=form>
          ...
          <tr>
              <td class=form_subheader><b><text style="font-size:20px;">Γραφείο:</style> </b></td>
