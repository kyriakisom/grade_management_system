...
<body>
  ...
  <div class="w3-top">
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
      ...
      <a class="w3-bar-item w3-button w3-hover-black" href="index_teacher_1.php">Το προφίλ μου</a>
      <a class="w3-bar-item w3-button w3-hover-black" href="index_teacher.php">Βαθμολογία φοιτητών</a>
      ...
      <div class="w3-twothird w3-container">
        ...
        <div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
          <div class="w3-display-middle" style="white-space:nowrap;">
            ...
            <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">Καλώς ήρθες Teacher!<span class="w3-hide-small"></span></span>
          </div>
        </div>
