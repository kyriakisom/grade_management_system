            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="delete_admin_4.php?StudentID='. $row['StudentID'] .'" class="btn btn-success pull-right">Διαγραφή </a>
                        <a href="update_admin_4.php?StudentID='. $row['StudentID'] .'" class="btn btn-success pull-right">Ενημέρωση </a>

                        <a href="insert_admin_4.php" class="btn btn-success pull-right"><i class="fa fa-plus">Προσθήκη Νέου Μαθήματος</i> </a>
                    </div>
                    <?php
                    // Include config file
                                                                             ...
                                                                             if($result = mysqli_query($link, $sql)){
                                                                                   ...
                                                                                   if(mysqli_num_rows($result) > 0){
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   echo "<th>ΚΩΔΙΚΟΣ ΜΑΘΗΜΑΤΟΣ</th>";
                                                                                                   echo "<th>ΟΝΟΜΑ ΜΑΘΗΜΑΤΟΣ</th>";
                                                                                                   echo "<th>ΕΞΑΜΗΝΟ ΔΙΔΑΣΚΑΛΙΑΣ</th>";
                                                                                                   echo "<th>ΜΟΝΑΔΕΣ ECTS</th>";
                                                                                                   echo "<th>ΚΑΤΑΣΤΑΣΗ</th>";
                                                                                                   echo "<th>ΩΡΕΣ ΘΕΩΡΙΑΣ</th>";
                                                                                                   echo "<th>ΩΡΕΣ ΕΡΓΑΣΤΗΡΙΟΥ</th>";
                                                                                               echo "</tr>";
                                                                                           echo "</thead>";
                                                                                           echo "<tbody>";
