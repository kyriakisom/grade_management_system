            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="update_admin_5.php?AdminID='. $row['AdminID'] .'" class="btn btn-success pull-right">Επεξεργασία </a>
                                                                             ...
                                                                             if($result = mysqli_query($link, $sql)){
                                                                                   ...
                                                                                   if(mysqli_num_rows($result) > 0){
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   echo "<th>ID ΔΙΑΧΕΙΡΙΣΤΉ</th>";
                                                                                                   echo "<th>ΌΝΟΜΑ ΔΙΑΧΕΙΡΙΣΤΉ</th>";
                                                                                                   echo "<th>ΕΠΏΝΥΜΟ ΔΙΑΧΕΙΡΙΣΤΉ</th>";
                                                                                                   echo "<th>EMAIL</th>";
