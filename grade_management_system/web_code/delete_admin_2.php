            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Teacher_Lastname']; ?></td>
                ...
                <td valign="center" align="center">
                    <form name="updateform" method="post" action="delete_admin_2.php">
                      <img src="icons/trash.jpg"  width="17" height="21">
                <!--        <input type="hidden" name="status" value="delete"> -->
                        <input type="hidden" name="SubjectID" value="<?php echo $row['SubjectID']; ?>"></td>
                        <td>
<a href="delete_admin_2.php?SubjectID=<?php echo  $row['SubjectID'];?>" onClick="return confirm('Είσαι σίγουρος ότι θες να διαγράψεις αυτό το μάθημα από τον χρήστη;')" >Delete</a>
                        </td>
