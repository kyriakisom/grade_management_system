...
&nbsp;
  ...
  <center>
    ...
    if (isset($_POST['submit']) && $_POST['submit'] == "Insert") {
        ...
        //check fname
        if ($SubjectID == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε τoν κωδικό του μαθήματος!<br></font>";
            $error = 1;
        }
        ...
        if ($Semester == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε το εξάμηνο!<br></font>";
            $error = 1;
        }
    ...
    <br>
    <form name="contactform" method="post" action="insert_admin_4.php">
        ...
        <table width="50%" class=form>
          <hr class="new5"></hr>
            ...
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Μονάδες ECTS: <text style="color:red;">*</text></text> </b></td>
            ...
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Ωρες θεωρίας: <text style="color:red;">*</text></text> </b></td>
                <td><input type="text" name="Theory_Hours" maxlength="80" size="30" value=<?php echo $Theory_Hours ?>></td>
            </tr>
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Ώρες εργαστηρίου: <text style="color:red;">*</text></text></b></td>
