            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Στοιχεία Καθηγητή</h2>
                        <!-- <a href="update_teacher.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Ενημέρωση </a> -->
...
echo '<a href="update_teacher.php?TeacherID='. $row['TeacherID'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
