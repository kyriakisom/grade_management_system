            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Στοιχεία Φοιτητών</h2>

                        <a href="deletee_admin_3.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Διαγραφή </a>
                        <a href="updatee_admin_3.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Ενημέρωση </a>

                        <a href="insert_admin_3.php" class="btn btn-success pull-right"><i class="fa fa-plus">Προσθήκη Νέου Φοιτητή</i> </a>
                                                                                           ...
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                ...
                                                                                                //   echo "<th >PASSWORD</th>";
                                                                                                   ...
                                                                                                   echo "<th>ΕΠΙΘΕΤΟ ΦΟΙΤΗΤΗ</t>";
                                                                                                   echo "<th>ΟΝΟΜΑ ΠΑΤΡΟΣ</th>";
                                                                                                   echo "<th>ΗΜΕΡΟΜΗΝΙΑ ΓΕΝΝΗΣΗΣ</th>";
                                                                                                   echo "<th>E-MAIL</th>";
                                                                                                   echo "<th>ΤΗΛΕΦΩΝΟ</th>";
                                                                                                   echo "<th>ΕΞΑΜΗΝΟ</th>";
                                                                                                   echo "<th>ΕΤΟΣ ΕΙΣΑΓΩΓΗΣ</th>";
                                                                                               echo "</tr>";
                                                                                           echo "</thead>";
                                                                                           echo "<tbody>";
