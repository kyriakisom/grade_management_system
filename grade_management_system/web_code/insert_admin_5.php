...
<html lang="en">
<head>
  <title>Εισαγωγή Διαχειριστή</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar" id="myNavbar">
      ...
      <button class="btn1 w3-bar-item w3-button w3-hide-small"><a href="arxiki_admin.php"><i class="fa fa-home"></i></a></button>
  ...
  <div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
    ...
    <br>
    <form name="contactform" method="post" action="insert_admin_5.php">
