...
<head>
    <meta charset="UTF-8">
    <title>Βαθμολογία Φοιτητών</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Βαθμολογία Φοιτητών</h2>
                        <a href="update_teacher1.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Ενημέρωση </a>
                        <a href="insert_teacher.php" class="btn btn-success pull-right"><i class="fa fa-plus">Προσθήκη Νέας Βαθμόλογιας</i></a>
                                                                                       ...
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   ...
                                                                                                   echo "<th>ΟΝΟΜΑ ΦΟΙΤΗΤΗ</th>";
                                                                                                   echo "<th>ΕΠΩΝΥΜΟ ΦΟΙΤΗΤΗ</th>";
                                                                                                   echo "<th>ID ΜΑΘΗΜΑΤΟΣ</th>";
                                                                                                   echo "<th>ΟΝΟΜΑ ΜΑΘΗΜΑΤΟΣ</th>";
                                                                                                   echo "<th>ΒΑΘΜΟΣ ΘΕΩΡΙΑΣ</th>";
                                                                                                   echo "<th>ΒΑΘΜΟΣ ΕΡΓΑΣΤΗΡΙΟΥ</th>";
                                                                                                   echo "<th>ΣΥΝΟΛΙΚΟΣ ΒΑΘΜΟΣ</th>";
                                                                                                   echo "<th>ΗΜΕΡΟΜΗΝΙΑ ΕΞΕΤΑΣΗΣ</th>";
                                                                                           ...
                                                                                           while($row = mysqli_fetch_array($result)){
                                                                                               echo "<tr>";
                                                                                                   ...
                                                                                                   echo "<td>" . $row['Theory_Grade'] . "</td>";
                                                                                                   echo "<td>" . $row['Lab_Grade'] . "</td>";
                                                                                                   echo "<td>" . $row['Total_Grade'] . "</td>";
                                                                                                   echo "<td>" . $row['Date_exam'] . "</td>";

                                      //echo "<td>";

                                    //  echo '<a href="update_teacher1.php?StudentID='. $row['StudentID'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                      // echo '<a href="delete_admin.php?TeacherID='. $row['StudentID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
