            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="deletee_admin.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Διαγραφή </a>
                        <a href="update_admin1_1.php?TeacherID='. $row['TeacherID'] .'" class="btn btn-success pull-right">Ενημέρωση </a>

                        <a href="insert_admin.php" class="btn btn-success pull-right"><i class="fa fa-plus">Προσθήκη Νέας Bαθμολογίας</i> </a>
                                                                                       ...
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   ...
                                                                                                   echo "<th>ID ΦΟΙΤΗΤΉ</th>";
                                                                                                   echo "<th>ΟΝΟΜΑ ΦΟΙΤΗΤΗ</th>";
                                                                                                   echo "<th>ΕΠΙΘΕΤΟ ΦΟΙΤΗΤΗ</th>";
