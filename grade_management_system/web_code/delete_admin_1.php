            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Lastname']; ?></td>
                ...
                <td valign="center" align="center">
                    <form name="updateform" method="post" action="delete_admin_1.php">
                      <img src="icons/trash.jpg"  width="17" height="21">
                        <input type="hidden" name="TeacherID" value="<?php echo $row['TeacherID']; ?>"></td>
                        <td>
<a href="delete_admin_1.php?TeacherID=<?php echo  $row['TeacherID'];?>" onClick="return confirm('Είσαι σίγουρος ότι θες να διαγράψεις τον χρήστη;')" >Delete</a>
                        </td>
