...
<head>
  ...
  &nbsp;
    ...
    if (isset($_POST['submit']) && $_POST['submit'] == "Insert") {
        ...
        if ($Status_t == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε την κατάσταση σας!<br></font>";
            $error = 1;
        }

        if ($Office == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε το γραφείο σας!<br></font>";
            $error = 1;
        }
        if ($error) {
    ...
    <form name="contactform" method="post" action="insert_admin_1.php">
        ...
        <table width="50%" class=form>
          <hr class="new5"></hr>
            ...
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Έτος πρόσληψης: <text style="color:red;">*</text></text></b></td>
                <td><input type="text" name="Year_e" maxlength="80" size="30" value=<?php echo $Year_e ?>></td>
            </tr>
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Κατάσταση: <text style="color:red;">*</text></text> </b></td>
                <td><input type="text" name="Status_t" maxlength="80" size="30" value=<?php echo $Status_t ?>></td>
            </tr>
            <tr>
                <td class=form_subheader><b><text style="font-size:20px;">Γραφείο: <text style="color:red;">*</text></text> </b></td>
