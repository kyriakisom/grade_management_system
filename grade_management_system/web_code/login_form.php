...
<hr ></hr>
          ...
          <form action="login_neo.php" method="post">
              ...
              <br></br>
              <p>Forgot Username? <a href="forgot_username.php">Click here</a>.</p>
              <p>Forgot Password? <a href="forgot_pasword.php">Click here</a>.</p>
          </form>
      </div>
