...
<head>
  ...
  <hr class="new5"></hr>
    ...
    if ((isset($_GET['SubjectID'])) ) {
        ...
        if ($result) {
            mysqli_commit($link);
            echo "<font color=\"#000000\"><strong><br>Η διαγραφή ολοκληρώθηκε με επιτυχία!!!<br></strong>";
        } else {
            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Student_Firstname']; ?></td>
                ...
                <td valign="center" align="center">
                    <form name="updateform" method="post" action="deletee_admin.php">
                      <img src="icons/trash.jpg"  width="17" height="21">
                <!--        <input type="hidden" name="status" value="delete"> -->
                        <input type="hidden" name="SubjectID" value="<?php echo $row['SubjectID']; ?>"></td>
                        <td>
<a href="deletee_admin.php?SubjectID=<?php echo  $row['SubjectID'];?>" onClick="return confirm('Είσαι σίγουρος ότι θες να διαγράψεις αυτή την βαθμολογία από τον χρήστη;')" >Delete</a>
                        </td>
