            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Διδασκαλία</h2>
                        <a href="delete_admin_2.php?StudentID='. $row['StudentID'] .'" class="btn btn-success pull-right">Διαγραφή </a>
                        <a href="update_admin_2.php?StudentID='. $row['StudentID'] .'" class="btn btn-success pull-right">Ενημέρωση </a>
                        <a href="insert_admin_2.php" class="btn btn-success pull-right"><i class="fa fa-plus">Ανάθεση Νέου Μαθήματος σε Διδάσκοντα</i> </a>
                                                                             ...
                                                                             if($result = mysqli_query($link, $sql)){
                                                                                   ...
                                                                                   if(mysqli_num_rows($result) > 0){
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   echo "<th>ID ΔΙΔΑΣΚΟΝΤΑ</th>";
                                                                                                   echo "<th>ΟΝΟΜΑ ΔΙΔΑΣΚΟΝΤΑ</th>";
                                                                                                   echo "<th>ΕΠΩΝΥΜΟ ΔΙΔΑΣΚΟΝΤΑ</th>";
