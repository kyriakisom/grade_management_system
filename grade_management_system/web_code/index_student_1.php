            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Το προφίλ μου</h2>
                    ...
                    $sql = "SELECT * FROM student WHERE StudentID = " . $_SESSION["ID"] . "";
                                                                                       ...
                                                                                       echo '<table class="table table-bordered table-striped">';
                                                                                           echo "<thead>";
                                                                                               echo "<tr>";
                                                                                                   ...
                                                                                                   echo "<th>EMAIL</th>";
                                                                                                   echo "<th>ΑΡΙΘΜΟΣ ΤΗΛΕΦΩΝΟΥ</th>";
                                                                                                   echo "<th>ΕΞΑΜΗΝΟ</th>";
                                                                                                   echo "<th>ΕΤΟΣ ΕΙΣΑΓΩΓΉΣ</th>";
                                      ...
                                      echo '<a href="update_student.php?StudentID='. $row['StudentID'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
