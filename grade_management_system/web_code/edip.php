...
<div class="navbar">
  ...
  <a href="edip.php">Καθηγητές Ε.ΔΙ.Π</a>
            ...
            <h3><b>Καθηγητές Ε.ΔΙ.Π:</b></h3>

            <p>  <button style="font-size:25px;" class="Btn_white_normal">
                       <a href="example.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
          <b></b>     </a>
               </button></p>

               <button style="font-size:25px;" class="Btn_white_normal">
                        <a href="example.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
               <b></b>     </a>
                </button>
          ...
          <!--  <ul>
  <li><p style="color:blue ;"><a href="kalligeross.html"><b>Καλλίγερος Εμμανουήλ</b></a></p></li>
  <li><p style="color:blue ;"><a href="konstantinous.html"><b>Κωνσταντίνου Ελισάβετ</b></a></p></li>
 <li><p style="color:blue ;"><a href="karyda.html"><b>Καρύδα Μαρία</b></a></p></li>
  <li><p style="color:blue ;"><a href="kaporiss.html"><b>Καπόρης Αλέξιος</b></a></p></li>
  </ul>-->
