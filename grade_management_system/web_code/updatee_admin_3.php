...
<center>
    ...
    if (isset($_POST['submit']) && $_POST['submit'] == "Update") {
        ...
        if ($error) {
            ...
            if ($result) {
                ...
                echo "<font color=\"#000000\"><strong><br>Η επεξεργασία δεν ολοκληρώθηκε λόγω προβλήματος!!!<br></strong></font>";
            }
        }
    }
    ?>
            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Fathers_name']; ?></td>
                ...
                <td valign="center" align="center">
                    <form name="updateform" method="post" action="updatee_admin_3.php">
    ...
    <form name="contactform" method="post" action="updatee_admin_3.php">
