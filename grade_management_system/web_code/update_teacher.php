...
<head>
  ...
  <a href="index_teacher_1.php" class="btn1 w3-bar-item w3-button w3-hide-small"><i style="font-size:18px" class="fa">&#xf100;</i>
  </a>
  <a href="logout.php" class="btn1 w3-bar-item w3-button w3-hide-small"><i style="font-size:17px" class="fa">&#xf08b;</i></a>
    ...
    &nbsp;
            <button class="btn1"><a href="index_teacher_1.php" ><i style="font-size:18px" class="fa">&#xf100;</i>
          </a></button>
          &nbsp;
...
<center>
    ...
    if (isset($_POST['submit']) && $_POST['submit'] == "Update") {
        ...
        if ($Year_e == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε τo έτος πρόσληψης σας!<br></font>";
            $error = 1;
        }
        if ($Status_t == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε την κατάσταση που βρίσκεστε!<br></font>";
            $error = 1;
        }

        if ($Office == "") {
            echo "<font color=\"#FF0000\">Πρέπει να συμπληρώσετε τo γραφείο σας!<br></font>";
            $error = 1;
        }
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr class="alt">
              ...
              <td><?php echo $row['Lastname']; ?></td>
                ...
                <td><?php echo $row['Status_t']; ?></td>
                <td><?php echo $row['Office']; ?></td>

                <td valign="center" align="center">
                    <form name="updateform" method="post" action="update_teacher.php">
    ...
    <form name="contactform" method="post" action="update_teacher.php">
        ...
        <table width="50%" class=form>
          ...
          <tr>
              ...
              <td><input type="text" name="Status_t" maxlength="80" size="30" value=<?php echo $Status_t ?>></td>
          </tr>
          <tr>
              <td class=form_subheader><b><text style="font-size:20px;">Έτος πρόσληψης: </text> </b></td>
              <td><input type="text" name="Year_e" maxlength="80" size="30" value=<?php echo $Year_e ?>></td>
          </tr>
          <tr>
              <td class=form_subheader><b><text style="font-size:20px;">Γραφείο: </text></style></b></td>
              <td><input type="text" name="Office" maxlength="80" size="30" value=<?php echo $Office ?>></td>
          </tr>
          </tr>
          <br>
          <tr>
